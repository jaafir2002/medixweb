            ...
            <nav aria-label="Clinic core values" className="space-y-2">
              {CLINIC_VALUES.map((val) => {
                ...
                const valueImages: Record<string, string> = {
                  compassion: '/src/assets/images/about_doctor_portrait_1790248368496.jpg',
                  collaboration: '/src/assets/images/care_team_scrubs_1790248388964.jpg',
                  transparency: '/src/assets/images/doctor_consultation_family_1790248379120.jpg',
                  flexibility: '/src/assets/images/hero_care_family_1790248293775.jpg',
                  excellence: '/src/assets/images/about_doctor_portrait_1790248368496.jpg',
                };
                const previewImg = valueImages[val.id] || '/src/assets/images/about_doctor_portrait_1790248368496.jpg';
